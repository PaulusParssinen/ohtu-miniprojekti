...
class TestReadingTip(unittest.TestCase):
    ...
    def test_str_format_correct_only_title_and_author_defined(self):
        reading_tip = ReadingTip(title='Tirakirja', author='laaksonen', url='wwww.tira.fi')
        self.assertEqual(str(reading_tip), 'Title: Tirakirja, Author: laaksonen, URL: wwww.tira.fi')
